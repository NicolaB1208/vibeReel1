"""Helpers for building video cuts from AI-generated plans."""
...
def execute_cut_plan(
    *,
    ...
    final_output = Path(
        final_output or (DEFAULT_CLIP_OUTPUT_DIR / f"{source_video.stem}_auto_edit.mp4")
    )
    concat_command, concat_list = build_concat_command(
        clips=clip_paths,
        output_path=final_output,
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            f"{DEFAULT_CLIP_OUTPUT_DIR}/<source_stem>_auto_edit.mp4"
            ")"
        ),
    )
