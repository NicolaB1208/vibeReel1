    ...
    "properties": {
        ...
        "segments": {
            ...
            "items": {
                ...
                "oneOf": [
                    {"required": ["phrase_text"], "properties": {"audio_event": {"type": "null"}}},
                    {"required": ["audio_event"], "properties": {"phrase_text": {"type": "null"}}},
                ],
...
__all__ = ["TRANSCRIPT_DOCUMENT_SCHEMA", "AI_CUT_PLAN_SCHEMA"]
